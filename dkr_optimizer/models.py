...
class OvertakePlanItem:
    ...
    time_delta_cs: int
    efficiency: float
    # Extra targets for +2..+5 positions above current rank on this leaderboard.
    # Each element is (actual_rank_achieved, time_delta_cs) or None if not enough players.
